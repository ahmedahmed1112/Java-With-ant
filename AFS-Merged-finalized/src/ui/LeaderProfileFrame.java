...
public class LeaderProfileFrame extends JFrame {
    ...
    private void buildUI() {
        ...
        cmbGender.setFont(UIUtils.font(13, Font.PLAIN));
        makeFieldTaller(cmbGender);
        ...
        gbc.gridy = 5; form.add(labeled("Gender", cmbGender), gbc);
    ...
    private void fillFromUser() {
        ...
        selectGender(safe(loggedInUser.getGender()));
    ...
    private void saveProfile() {
        ...
        String gender = String.valueOf(cmbGender.getSelectedItem()).trim();
    ...
    private void selectGender(String gender) {
        String target = safe(gender).trim();
        if (target.isEmpty()) {
            cmbGender.setSelectedIndex(0);
            return;
        }
        for (int i = 0; i < cmbGender.getItemCount(); i++) {
            String value = String.valueOf(cmbGender.getItemAt(i));
